...
* Bump dependabot/fetch-metadata from 2.4.0 to 2.5.0 by @dependabot[bot] in https://github.com/lara-zeus/sky/pull/258

**Full Changelog**: https://github.com/lara-zeus/sky/compare/v4.1.2...v5.0.0
...
* Bump dependabot/fetch-metadata from 2.4.0 to 2.5.0 by @dependabot[bot] in https://github.com/lara-zeus/sky/pull/258
* fix if content is array like RichEditor by @atmonshi in https://github.com/lara-zeus/sky/pull/262
* Bump actions/checkout from 5 to 6 by @dependabot[bot] in https://github.com/lara-zeus/sky/pull/257
* Bump ramsey/composer-install from 3 to 4 by @dependabot[bot] in https://github.com/lara-zeus/sky/pull/260
* Bump dependabot/fetch-metadata from 2.5.0 to 3.0.0 by @dependabot[bot] in https://github.com/lara-zeus/sky/pull/261

**Full Changelog**: https://github.com/lara-zeus/sky/compare/v4.1.2...v4.2.0

## v4.1.2 - 2025-11-11

### What's Changed

* Added Turkish translation files by @gsarigul84 in https://github.com/lara-zeus/sky/pull/256

### New Contributors

* @gsarigul84 made their first contribution in https://github.com/lara-zeus/sky/pull/256

**Full Changelog**: https://github.com/lara-zeus/sky/compare/v4.1.1...v4.1.2
...
* Bump aglipanci/laravel-pint-action from 2.5 to 2.6 by @dependabot[bot] in https://github.com/lara-zeus/sky/pull/252
* Bump stefanzweifel/git-auto-commit-action from 5 to 7 by @dependabot[bot] in https://github.com/lara-zeus/sky/pull/251
* Bump actions/checkout from 4 to 5 by @dependabot[bot] in https://github.com/lara-zeus/sky/pull/250
* refactor the localization to php files by @atmonshi in https://github.com/lara-zeus/sky/pull/254

### ⚠️ if you have custom translation, this will be a breaking change for you, please republish the translation files.

**Full Changelog**: https://github.com/lara-zeus/sky/compare/v4.0.5...v4.1.0

## v4.0.5 - 2025-10-22

### What's Changed

* final v4 updates by @atmonshi in https://github.com/lara-zeus/sky/pull/249

**Full Changelog**: https://github.com/lara-zeus/sky/compare/v4.0.4...v4.0.5
