...
class PostStatus extends Model
{
    ...
    public function getRows()
    {
        return [
            ...
            ['name' => 'auto-draft', 'label' => __('Auto draft'), 'class' => 'px-2 py-0.5 text-xs rounded-xl text-info-700 bg-info-500/10', 'icon' => 'iconpark-filesearchone'],
            ...
            ['name' => 'inherit', 'label' => __('Inherit'), 'class' => 'px-2 py-0.5 text-xs rounded-xl text-gray-700 bg-gray-500/10', 'icon' => 'iconpark-filetipsone'],
        ];
    }
